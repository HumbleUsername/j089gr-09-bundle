...
class SKU {
    static fromString(sku) {
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            if (attribute === 'uncraftable') attributes.craftable = false;
            else if (attribute === 'australium') attributes.australium = true;
            else if (attribute === 'festive') attributes.festive = true;
            else if (attribute === 'strange') attributes.quality2 = 11;
        ...
        return objectPrettify(defaults(attributes, TEMPLATE), TEMPLATE);
    }
    ...
    static fromObject(item) {
        ...
        if (item.australium) sku += ';australium';
        if (!item.craftable) sku += ';uncraftable';
...
},{"defaults":6,"object-prettify":7}],5:[function(require,module,exports){
(function (Buffer){(function (){
var clone = (function() {
'use strict';
